...
function OrionLib:MakeWindow(WindowConfig)
	...
	WindowConfig.Name = WindowConfig.Name or "DANGO HUB"
	...
	WindowConfig.IntroText = WindowConfig.IntroText or "DANGO HUB"
	...
	AddConnection(CloseBtn.MouseButton1Up, function()
	  OrionLib:MakeNotification({Name = "DANGO HUB",Content = "Destroy Script..." ,Image = "rbxassetid://",Time = 5})task.wait(1)
	  Orion:Destroy()
	end)

	OrionLib:MakeNotification({Name = "DANGO HUB",Content = "Execute Script..." ,Image = "rbxassetid://",Time = 5})
